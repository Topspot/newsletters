        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::open(['url' => 'admin/attorneys','files' => true,'class' => 'attorneyform']) !!}
                    ...
                    <div class="form-group">
                     ...
                     <div class="field_wrapper3">
                        ...
                        {!! Form::text('thankyou_text[]', null, ['class' => 'form-control']) !!}
                    ...
                    <div class="form-group">
                        {!! Form::label('attorney_img', 'Attorney Image: ') !!}
                    ...
                    <div class="field_wrapper4">
                        <div>
                            {!! Form::label('phone_number', 'Footer Phone Number : ') !!}
                    ...
                    <div class="field_wrapper5">
                        <div>
                            ...
                            {!! Form::text('footer_address[]', null, ['class' => 'form-control']) !!}
                    ...
                    <div class="field_wrapper6">
                        <div>
                            ...
                            {!! Form::text('footer_website[]', null, ['class' => 'form-control']) !!}
                    ...
                    <div class="form-group">
                        {!! Form::label('unsubscribe', 'Unsubscribe Link: ') !!}
